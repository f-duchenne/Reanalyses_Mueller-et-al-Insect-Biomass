...
ggtitle("c")+scale_fill_manual(values=colo)+scale_y_continuous(labels=percent)+ylab("Contribution do decline (%/year)")
...
pdf("FigSI.pdf",width=9,height=5)
